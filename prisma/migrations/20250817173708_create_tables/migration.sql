-- CreateEnum
CREATE TYPE "public"."PaymanetStatus" AS ENUM ('PENDING', 'PAID', 'FAILED');
...
-- AddForeignKey
ALTER TABLE "public"."Donations" ADD CONSTRAINT "Donations_userdId_fkey" FOREIGN KEY ("userdId") REFERENCES "public"."User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
